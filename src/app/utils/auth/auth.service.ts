...
export class AuthService
{
    ...
    check(): Observable<boolean>
    {
        ...
        let token_access=(this._tokenService.getTokenFromLocal()!=null ? this._tokenService.getTokenFromLocal():this._tokenService.getTokenFromSession())
        ...
        if ( this.isTokenExpired(token_access) )
        {
            return of(false);
        }
